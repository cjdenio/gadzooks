    ...
    <div>
      ...
      <div className="py-20">
        <div className="w-4/5 max-w-3xl mx-auto">
          ...
          <div className="flex gap-3 flex-wrap">
            <div className="shadow-md flex-1 bg-purple-500 text-white p-5 rounded-lg">
      ...
      <div className="py-20 bg-green-400">
        <div className="w-4/5 max-w-3xl mx-auto">
          ...
          <div className="flex gap-3 flex-wrap">
            <div className="shadow-md flex-1 bg-white p-5 rounded-lg">
              <h2 className="text-4xl font-bold mb-3">
      ...
      <div className="py-20">
        <div className="w-4/5 max-w-3xl mx-auto">
          ...
          <div className="flex gap-3 flex-wrap">
            <div className="shadow-md flex-1 bg-green-400 p-5 rounded-lg">
